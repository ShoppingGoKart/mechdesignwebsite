...
The goal for this project is to create a functional go-kart vehicle. The Ferrari GK is a go-kart built around a shopping cart frame and a 1/3 HP motot and includes functional steerage, breaking, and acceleration.
...
During the engineering process, there are 
